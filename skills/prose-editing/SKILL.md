...
name: prose-editing
description: >-
  Improving copy and prose that already exists — marketing pages, landing copy, UI text, docs passages or an article draft — in focused single-dimension passes: the seven sweeps (clarity, voice, so-what, proof, specificity, emotion, risk), quick word and sentence checks, and an AI-tell pass covering em-dash overuse and overused-word blacklists. Use on "edit this copy", "proofread", "polish this", "tighten this up", "does this sound AI-written". Edits, never writes from scratch.
---
